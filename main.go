...
func main() {
	...
	ordersRoutes.POST("/pickup", controllers.AuthMiddleware("CUSTOMER"), controllers.InsertOrderPickup)
	...
	productsRoutes.GET("/noncoffee", controllers.AuthMiddleware("ADMIN", "CUSTOMER"), controllers.GetProductsNonCoffeeByBranch)
	productsRoutes.GET("/donut", controllers.AuthMiddleware("ADMIN", "CUSTOMER"), controllers.GetProductsDonutByBranch)
