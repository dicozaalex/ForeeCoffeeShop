    ...
    return (
        <>
            ...
            <div className='h-screen' style={{ backgroundColor: '#1C5739', minHeight: '130vh' }}>
                ...
                <div style={{ position: 'fixed', bottom: '10px', left: '10px', right: '10px', padding: '12px', borderRadius: '20px', backgroundColor: '#368D61',  zIndex: '9999' }}>
                    <button onClick={handleLatestButtonClick} style={{ display: 'flex', alignItems: 'center', margin: '0 auto', width: '100%', backgroundColor: 'transparent', border: 'none' }}>
