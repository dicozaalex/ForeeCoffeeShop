            ...
            <div className={styles.fullScreen}>
                <div className={styles.information}>
                    <div className={styles.infoItem}>
                        <img className={styles.circledImage} src={`${process.env.PUBLIC_URL}/assets/Order/delivery-motor.png`} alt="delivery" />
                    ...
                    <div className={styles.infoItem} style={{ marginTop: '20px' }}>
                        <img className={styles.circledImage} src={`${process.env.PUBLIC_URL}/assets/Order/location.png`} alt="location" />
                        <div className={styles.infoText}>
                            <span>Location</span>
                    ...
                    <div className={styles.infoItem} style={{ marginTop: '20px' }}>
                        <img src={`${process.env.PUBLIC_URL}/assets/Order/phone.png`} alt="phone" />
                        <div className={styles.infoText}>
